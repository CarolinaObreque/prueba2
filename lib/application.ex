defmodule Prueba2.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      {Prueba2.TeamManager, []},
      # Supervisar el gestor de juego
      {Prueba2.GameManager, []},
      # Supervisar el gestor de turnos
      {Prueba2.ShiftManager, []},
      # Supervisar el sincronizador de posiciones entre nodos
      {Prueba2.TeamPositionSync, []},
